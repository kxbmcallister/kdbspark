...
object Util {
  ...
  /* Temporary function to time various operations */
  def timer[R](function: => R): Long = {
...
object Kdb {
  ...
  def query(options: java.util.Map[String,String], filters: Array[Object], schema: StructType): Object = {
    ...
    val objmap = Map[String, Object]("filters" -> filters, "columns" -> schemaColumns(schema))
