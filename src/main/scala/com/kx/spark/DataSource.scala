...
class KdbDataSourceReader(var schema: StructType, options: DataSourceOptions) 
  ...
  override def createBatchDataReaderFactories: JList[DataReaderFactory[ColumnarBatch]] = {
      ...
      var rts = new ArrayList[DataReaderFactory[ColumnarBatch]]      
...
class KdbDataWriterFactory(jobid: String, schema: StructType, mode: SaveMode, optionmap: Map[String,String]) extends DataWriterFactory[Row] { 
